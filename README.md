...
Учебный проект на C++, представляющий собой консольное приложение для применения графических фильтров к BMP-изображениям.  
Проект был выполнен в рамках итогового задания по курсу C++ и включает собственную реализацию чтения и записи 24-bit BMP, обработку изображений и последовательное применение фильтров без использования сторонних библиотек.

## Реализованные возможности

- чтение и запись 24-bit BMP изображений;
- применение фильтров через аргументы командной строки;
- последовательная обработка нескольких фильтров;
- базовые фильтры: `crop`, `grayscale`, `negative`, `sharpening`, `edge detection`, `gaussian blur`;
